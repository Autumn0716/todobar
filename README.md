...
从 [GitHub Release](https://github.com/Autumn0716/todobar/releases/download/v0.1.0/TodoBar-0.1.0.dmg) 下载 `.dmg`，双击打开，将 TodoBar 拖入应用程序文件夹。首次打开需在 **系统设置 → 隐私与安全性** 点「仍要打开」。
